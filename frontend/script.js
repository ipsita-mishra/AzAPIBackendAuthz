const useHash = true;
const apiUrl = 'https://lucasreta.com/stack-overflow/spa-vanilla-js/api'; //REPLACE
const routes = ['signin', 'signout', '/api/insensitive', '/api/sensitive'];
...
function get(page) {
  ...
  xhr.onreadystatechange = function() {
    if (this.readyState == 4 && this.status == 200) {
      ...
      const title = `${data.title} | AzAPIBackendAuthz`;
